...
Draw(void)
{
    vivid::DrawText(25, "‰Á‘¬’l", { m_accelerator_var_position.x, m_accelerator_var_position.y - 25.0f });
    vivid::DrawText(25, "Å‘å‘¬“x", { m_max_accelerator_var_position.x, m_max_accelerator_var_position.y - 25.0f });
